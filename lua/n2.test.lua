...
test(I8(-101), '9b1c')
test(U16(60000), '0c28')
test(U16(60001), '61ea00001e')
test(I16(-30000), '0528')
test(I16(-30001), 'cf8a1d')
test(U32(4000000000), '0832')
test(U32(4000000001), '01286bee000000001f')
test(I32(-2000000000), '0332')
test(I32(-2000000001), 'ff6bca881e')
...
u16Box[0] = 0xf0f0
test(u16Box, 'f0f062')
test(u16Box[0], '18181d22')
i16Box[0] = -0x0f0f
test(i16Box, 'f1f062')
test(i16Box[0], 'f1f01d')
u32Box[0] = 0xf0f0f0f0
test(u32Box, 'f0f0f0f064')
test(u32Box[0], '181818181e22')
i32Box[0] = -0x0f0f0f0f
